          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:radifam06@gmail.com" className="text-white hover:text-violet-400 transition-colors">radifam06@gmail.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+6282245480975" className="text-white hover:text-violet-400 transition-colors">+6282245480975</a>
                  </div>
                </div>
            ...
            <div className="p-8 bg-black/40 backdrop-blur-lg rounded-xl border border-white/10 shadow-xl">
              ...
              <div className="flex flex-wrap gap-4">
                {/* GitHub */}
                <a href="https://github.com/RadifAfta" target="_blank" rel="noopener noreferrer" className="group p-3 bg-black/50 rounded-lg border border-white/10 transition-all duration-300 hover:border-violet-500/50 hover:scale-110">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/radifaftamaulana/" target="_blank" rel="noopener noreferrer" className="group p-3 bg-black/50 rounded-lg border border-white/10 transition-all duration-300 hover:border-violet-500/50 hover:scale-110">
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-violet-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/radifaftamaulana/" target="_blank" rel="noopener noreferrer" className="group p-3 bg-black/50 rounded-lg border border-white/10 transition-all duration-300 hover:border-violet-500/50 hover:scale-110">
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-violet-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
