        ...
        <div className="max-w-4xl mx-auto mt-20">
          <div className="p-8 rounded-2xl bg-black/40 backdrop-blur-sm border border-white/10 hover:border-violet-500/30 transition-all duration-300 shadow-xl shadow-black/50">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
              ...
              <a href="https://github.com/RadifAfta" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-500/10 border border-violet-500/20 text-violet-300 rounded-lg hover:bg-violet-500/20 hover:text-white transition-all duration-300 focus:ring-2 focus:ring-violet-500 focus:outline-none">
